...
function Modal({ onClose, id ,setTodos,todos}) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`https://todo-list-ku1v.onrender.com/todos/todo?id=${id}`);
  ...
  function edit(){
    ...
    axios.put(`https://todo-list-ku1v.onrender.com/todos/todo?id=${id}`,urlEncodedData)
    .then(()=>{
